...
train_df = train_df.dropna(subset=['images', 'cvd'])
val_df = val_df.dropna(subset=['images', 'cvd'])
...
# prediction_df.to_csv('nlst_predictions_vit.csv', index=False, encoding='utf-8')
# print("Predictions saved to 'nlst_predictions_vit.csv'")